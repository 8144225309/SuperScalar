# shape-3b-N8-ARITY34-STATIC1 V2 - Commands

Proves: Static-root force-close: static root broadcast -> mid -> 8 leaves -> 8 client sweeps.
...
## Launch
```
ssh root@68.168.216.243 'systemd-run --unit=ss-t4-phase5-3b-V2.service \
  --setenv WALLET=ss_pool_5 --setenv TAG=phase5_3b_V2 --setenv VARIANT=V2 \
  bash /root/SuperScalar-phase5/docs/testnet4-phase5/shape-3b-N8-ARITY34-STATIC1/runner.sh'
```
Variant V2 -> `--demo --force-close`. Port 9952.

## Monitor
```
ssh root@68.168.216.243 'tail -f /tmp/ss_t4_phase5_3b_V2_lsp.log'
ssh root@68.168.216.243 'journalctl -u ss-t4-phase5-3b-V2.service -f'
```
...
## Stop (if needed)
```
ssh root@68.168.216.243 'systemctl stop ss-t4-phase5-3b-V2.service'
```
