# shape-3epp-N16-ARITY3-K2 V3 - Results

See `V3-commands.md` for the launch protocol. Filled in as the run progresses.
...
|---|---|---|---|
| Funding TX                     | TBD | TBD | from ss_pool_10 |
