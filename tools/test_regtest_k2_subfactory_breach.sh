...
CLIENT_SECKEYS=()
# Auto-generate up to 255 client seckeys (clients 1..255 -> seckey 0x02..0xff).
# Supports k up to 15 (canonical k^2 shape) and SF-SCALE N>=64 + k=4.
# Same scheme as tools/test_testnet4_n64_ps_lifecycle.sh line 89.
